...
export function FormNewChild({ props, node, paddingLeftSum }: Props) {
    ...
    // Создание полностью новой строки
    ...
    return (
        <>
            ...
            <tr>
                <td colSpan={6}>
                    <button className="bg-transparent   p-2 rounded" onClick={handleFormSubmit}>Создать</button>
                </td>
            </tr>
        </>
    )
